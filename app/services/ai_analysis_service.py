    ...
    def build_signal_snapshot(signal: Signal) -> dict:
        ...
        return {
            ...
            "market_data": {
                ...
                "prev_close": latest_md.prev_close if latest_md else None,
                "nav": latest_md.nav if latest_md else None,
                "acc_nav": latest_md.acc_nav if latest_md else None,
                "est_nav": latest_md.est_nav if latest_md else None,
                "iopv": latest_md.iopv if latest_md else None,
                "volume": latest_md.volume if latest_md else None,
                "amount": latest_md.amount if latest_md else None,
                "turnover_rate": latest_md.turnover_rate if latest_md else None,
                "amplitude": latest_md.amplitude if latest_md else None,
                "open_gap_pct": latest_md.open_gap_pct if latest_md else None,
                "premium_discount_pct": latest_md.premium_discount_pct if latest_md else None,
                "premium_discount_zscore_20d": latest_md.premium_discount_zscore_20d if latest_md else None,
                ...
                "atr14": latest_md.atr14 if latest_md else None,
                "volatility_20d": latest_md.volatility_20d if latest_md else None,
                "return_5d": latest_md.return_5d if latest_md else None,
                "return_20d": latest_md.return_20d if latest_md else None,
                "return_60d": latest_md.return_60d if latest_md else None,
                "breakout_high_20d": latest_md.breakout_high_20d if latest_md else None,
                "breakdown_low_20d": latest_md.breakdown_low_20d if latest_md else None,
                "drawdown_60d": latest_md.drawdown_60d if latest_md else None,
                "max_drawdown_120d": latest_md.max_drawdown_120d if latest_md else None,
                "relative_strength_20d": latest_md.relative_strength_20d if latest_md else None,
                "volume_ma20": latest_md.volume_ma20 if latest_md else None,
                "volume_ratio_5d": latest_md.volume_ratio_5d if latest_md else None,
            },
            "assignment": {
